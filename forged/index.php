...
$mysqli2= mysqli_connect("localhost","root","0000") or die ("could not connect to mysql"); 
...
<head>
    <title>Forged - LISK Delegate Vote Pool to Forge</title>
    <!-- Meta -->
    <meta charset="utf-8">
...
<body class="blog-home-page">   
                    ...
                    <div id="navbar-collapse" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"><a href="..">'.$lang['Home'].'</a></li>
													...
													<li class="active nav-item"><a href="../forged">'.$lang['Forged'].'</a></li>
    ...
    <section class="contact-section section">
        <div class="container">
        <h2 class="title text-center"><br>'.$lang['FORGED_HOME'].'</h2>
...
<table class="rwd-table">
  ...
  <tr>
   ...
   ';
$sql_forged = "SELECT height,timestamp,blockid,totalForged FROM forged ORDER BY height DESC LIMIT 100;";
$Result2 = mysqli_query($mysqli2,$sql_forged)or die("Database Error");
 while ($row2=mysqli_fetch_row($Result2)){  
    ...
    $totalForged = $row2[3];
     echo '
	  <tr>
	    <td data-th='.$lang['BLOCKS'].'>'.$height.'</td>
	    <td data-th='.$lang['DATETIME'].'>'.$timestamp.'</td>
	    <td data-th='.$lang['BLOCKID'].'>'.$blockid.'</td>
	    <td data-th='.$lang['FORGED'].'>'.$totalForged.'</td>
	  </tr>
