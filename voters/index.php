...
<head>
    <title>Voters - LISK Delegate Vote Pool to Forge</title>
    <!-- Meta -->
    <meta charset="utf-8">
...
<body class="blog-home-page">   
                    ...
                    <div id="navbar-collapse" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"><a href="..">'.$lang['Home'].'</a></li>
													...
													<li class="active nav-item"><a href="../voters">'.$lang['Voters'].'</a></li>
    ...
    <section class="contact-section section">
        <div class="container">
        <h2 class="title text-center"><br>'.$lang['VOTERS_HOME'].'</h2>
...
while ($row2=mysqli_fetch_row($Result2)){
    ...
    $voterpower = $row2[1];
    $balance = $row2[0];;
    $balance_hm = floatval($balance/100000000); 
    $voterpower_hm = floatval($voterpower/100000000); 

    $linkaddr = "../stats/miner/?id=".$uaddr;
   
    echo '
	  <tr>
	    <td data-th='.$lang['USERNAME'].'>'.$uname.'</td>
	   
	   
	   <td data-th='.$lang['ADDRESS'].'><a href='.$linkaddr.' onClick="">'.$uaddr.'</a></td>
	   
	    <td data-th='.$lang['BALANCE'].'>'.$balance_hm.'</td>
	    <td data-th='.$lang['VOTING_PWR'].'>'.$voterpower_hm.'</td>
	  </tr>
